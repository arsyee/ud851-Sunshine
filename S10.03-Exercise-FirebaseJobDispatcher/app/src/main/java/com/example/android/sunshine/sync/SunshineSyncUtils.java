...
//  COMPLETED (10) Add constant values to sync Sunshine every 3 - 4 hours
    ...
    private static final int MIN_SYNC = 3 * SECONDS_IN_HOUR;
    private static final int MAX_SYNC = 4 * SECONDS_IN_HOUR;

    private static boolean sInitialized;

//  COMPLETED (11) Add a sync tag to identify our sync job
    private static final String syncTag = "sync_job";
...
//  COMPLETED (12) Create a method to schedule our periodic weather sync
    private static void schedule(Context context) {
        ...
        Job job = jobDispatcher.newJobBuilder()
                ...
                .setRecurring(true)
                .setTrigger(Trigger.executionWindow(MIN_SYNC, MAX_SYNC))
