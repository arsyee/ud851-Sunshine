...
public class SunshinePreferences {
    ...
    public static String getPreferredWeatherLocation(Context context) {
        ...
        String preferredLocation = sharedPreferences.getString(context.getString(R.string.pref_location_key), DEFAULT_WEATHER_LOCATION);
        Log.d(TAG, "getPreferredWeatherLocation returns: " + preferredLocation);
    ...
    public static boolean isMetric(Context context) {
        ...
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
        boolean isMetric = sharedPreferences.getString(context.getString(R.string.pref_units_key),
                                                       context.getString(R.string.pref_units_metric)).
                                             equals(context.getString(R.string.pref_units_metric));
        Log.d(TAG, "isMetric returns " + isMetric);
        return isMetric;
    }
