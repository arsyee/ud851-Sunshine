...
//      COMPLETED (7) Display the weather icon using mDetailBinding
        mDetailBinding.lSummary.weatherIcon
                .setImageResource(SunshineWeatherUtils.getLargeArtResourceIdForWeatherCondition(
...
//      COMPLETED (8) Use mDetailBinding to display the date
        mDetailBinding.lSummary.date.setText(dateText);
...
//      COMPLETED (9) Use mDetailBinding to display the description and set the content description
        ...
        mDetailBinding.lSummary.weatherDescription.setText(description);
        mDetailBinding.lSummary.weatherDescription.setContentDescription(getString(R.string.a11y_forecast, description));

//      COMPLETED (16) Set the content description of the icon to the same as the weather description a11y text
        mDetailBinding.lSummary.weatherIcon.setContentDescription(getString(R.string.a11y_forecast, description));
...
//      COMPLETED (10) Use mDetailBinding to display the high temperature and set the content description
        ...
        mDetailBinding.lSummary.highTemperature.setText(highString);
        mDetailBinding.lSummary.highTemperature.setContentDescription(getString(R.string.a11y_high_temp, highString));
...
//      COMPLETED (18) Create the content description for the low temperature for a11y
        mDetailBinding.lSummary.lowTemperature.setContentDescription(getString(R.string.a11y_low_temp, lowString));
...
//      COMPLETED (11) Use mDetailBinding to display the low temperature and set the content description
        ...
        mDetailBinding.lSummary.lowTemperature.setText(lowString);
...
//      COMPLETED (12) Use mDetailBinding to display the humidity and set the content description
        ...
        mDetailBinding.humidity.setContentDescription(getString(R.string.a11y_humidity, humidityString));

//      COMPLETED (19) Set the content description of the humidity label to the humidity a11y String
        mDetailBinding.humidityLabel.setContentDescription(getString(R.string.a11y_humidity, humidityString));
...
//      COMPLETED (13) Use mDetailBinding to display the wind and set the content description
        ...
        mDetailBinding.wind.setContentDescription(getString(R.string.a11y_wind, windString));

//      COMPLETED (22) Set the content description of the wind label to the wind a11y String
        mDetailBinding.windLabel.setContentDescription(getString(R.string.a11y_wind, windString));
...
//      COMPLETED (14) Use mDetailBinding to display the pressure and set the content description
        ...
        mDetailBinding.pressure.setContentDescription(getString(R.string.a11y_pressure, pressureString));

//      COMPLETED (24) Set the content description of the pressure label to the pressure a11y String
        mDetailBinding.pressureLabel.setContentDescription(getString(R.string.a11y_pressure, pressureString));
