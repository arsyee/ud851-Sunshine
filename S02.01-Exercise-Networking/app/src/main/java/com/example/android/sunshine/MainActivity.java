...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadWeatherData() {
        ...
        new RefreshOpenWeatherTask().execute(preferredLocation);
    }

    // COMPLETED (5) Create a class that extends AsyncTask to perform network requests
    private class RefreshOpenWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected String[] doInBackground(String... params) {
            ...
            if (params.length == 1) {
                ...
                openWeatherMapUrl = NetworkUtils.buildUrl(locationQuery);
                try {
                    result = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this,
                            NetworkUtils.getResponseFromHttpUrl(openWeatherMapUrl));
